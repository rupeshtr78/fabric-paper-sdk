...
async function main() {
    try {
        ...
        const caURL = ccp.certificateAuthorities['ca-DigiBank.com'].url;
        ...
        const identity = X509WalletMixin.createIdentity('DigiBankMSP', enrollment.certificate, enrollment.key.toBytes());
