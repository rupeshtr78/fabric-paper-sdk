...
async function main() {
  ...
  try {
    ...
    const userName = 'bondbuyer1@DigiBank.com';
    ...
    const buyResponse = await contract.submitTransaction('buy', 'MagnetoCorp', '00004', 'MagnetoCorp', 'DigiBank', '4900000', '2020-05-31');
